...
SECRET_KEY = 'django-insecure-pkb-8hzpy*^r+o#*o#*g208o9l((+(g_ro*$s7a(t*9hd!lv6h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "brabantse_gebouwen.urls"
ROOT_HOSTCONF = "brabantse_gebouwen.hosts"

DEFAULT_HOST = "brabantse_gebouwen"
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "brabantse_gebouwen",  # Ensure the project is listed before any other arches applications
)
...
# ES_MAPPING_MODIFIER_CLASSES = ["brabantse_gebouwen.search.es_mapping_modifier.EsMappingModifier"]
